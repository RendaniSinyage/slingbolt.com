...
@section('content')
    ...
    <div id="printableArea">
        <div class="row mt-3">
            <div class="col mb-4">
                <input type="hidden"
                    value="{{ __('Account Statement') . ' ' . $filter['type'] . ' ' . 'Report of'.' '. ($filter['startDateRange'] ? \Carbon\Carbon::parse($filter['startDateRange'])->format('d F Y') : '') . ' to ' . ($filter['endDateRange'] ? \Carbon\Carbon::parse($filter['endDateRange'])->format('d F Y') : '') }}" id="filename">

    ...
    <div id="printableArea">
        <div class="row mt-1">
            <div class="col-12 col-sm-6 mb-4">
               <input type="hidden" value="{{__('Quarterly Cashflow').' '.'Report of'.' '. ($filter['startDateRange'] ? \Carbon\Carbon::parse($filter['startDateRange'])->format('d F Y') : '') . ' to ' . ($filter['endDateRange'] ? \Carbon\Carbon::parse($filter['endDateRange'])->format('d F Y') : '') }}" id="filename">

...
@section('content')
    ...
    <div id="printableArea">
        <div class="row mt-1">
            <div class="col mb-4">
                <input type="hidden" value="{{__('Monthly Cashflow').' '.'Report of'.' '. \Carbon::parse($filter['startDateRange']->format('d F Y') . ' to ' . \Carbon::parse($filter['endDateRange']->format('d F Y') }}" id="filename">

    ...
    <div id="printableArea">
        <div class="row mt-0">
            <div class="col-12 col-sm-6 col-md-6 col-xl-6 mb-4">
                <input type="hidden" value="{{__('POS Vs Purchase').' '.'Report of'.' '. \Carbon::parse($filter['startDateRange']->format('d F Y') . ' to ' . \Carbon::parse($filter['endDateRange']->format('d F Y') }}" id="filename">
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0">{{ \Carbon::parse($filter['startDateRange']->format('d F Y') . ' to ' . \Carbon::parse($filter['endDateRange']->format('d F Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>

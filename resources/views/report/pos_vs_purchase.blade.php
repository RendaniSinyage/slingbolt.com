    ...
    <div id="printableArea">
        <div class="row mt-0">
            <div class="col-12 col-sm-6 col-md-6 col-xl-6 mb-4">
                <input type="hidden" value="{{__('POS Vs Purchase').' '.'Report of'.' '. \\Carbon\\Carbon::parse($filter['startDateRange'])->format('d F Y') . ' to ' . \\Carbon\\Carbon::parse($filter['endDateRange'])->format('d F Y') }}" id="filename">

    ...
    <div class="row justify-content-center" id="printableArea">
        <div class="col-md-10">
            ...
            <div class="card-header">
                <h5>{{ 'Profit & Loss of ' . Auth::user()->name . ' as of ' . \\Carbon\\Carbon\Carbon::parse($filter['startDateRange'])->format('d F Y') . ' to ' . \\Carbon\\Carbon\Carbon::parse($filter['endDateRange'])->format('d F Y') }}
                </h5>
            </div>

...
class FixedEmailTemplateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $templates = [
            ...
            [
                ...
                'content' => '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
                    ...
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Your <strong>{current_plan_name}</strong> trial expires on <strong>{expiry_date}</strong> ({days_left} days remaining).</p>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Don\'t lose access to your premium features! Upgrade now to continue using {current_plan_name}.</p>
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="{upgrade_link}" style="background-color: #28a745; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block; font-size: 16px;">Upgrade to {current_plan_name} →</a>
                    </div>
            ...
            [
                ...
                'content' => '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
                    ...
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Hi {user_name},</p>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Your <strong>{current_plan_name}</strong> trial has ended and your account has been moved to our <strong>{free_plan_name}</strong>.</p>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">You won\'t be billed automatically, but to restore full access to your data and premium features, please upgrade to continue using {current_plan_name}.</p>
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="{upgrade_link}" style="background-color: #28a745; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block; font-size: 16px;">Continue with {current_plan_name} →</a>
                    </div>
                    <p style="font-size: 14px; color: #777; text-align: center;">
                        <a href="{app_url}plans" style="color: #007cba; text-decoration: none;">Or view all available plans →</a>
                    </p>
            ...
            [
                ...
                'slug' => 'plan_expiring',
                'from' => 'Billing Team',
                'subject' => 'Your {current_plan_name} subscription expires in {days_left} days',
                'content' => '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
                    <h2 style="color: #333; margin-bottom: 20px; text-align: center;">Subscription Expires Soon</h2>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Hi {user_name},</p>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Your <strong>{current_plan_name}</strong> subscription expires on <strong>{expiry_date}</strong> (7 days remaining).</p>
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="{app_url}plans" style="background-color: #007cba; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block; font-size: 16px;">Renew {current_plan_name} →</a>
                    </div>
                    <p style="font-size: 14px; color: #777; text-align: center;">
            ...
            [
                ...
                'slug' => 'plan_expired',
                'from' => 'Billing Team',
                'subject' => 'Your {current_plan_name} subscription has expired',
                'content' => '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
                    <h2 style="color: #333; margin-bottom: 20px; text-align: center;">Subscription Expired</h2>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Hi {user_name},</p>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Your <strong>{current_plan_name}</strong> subscription has expired and your account has been moved to our <strong>{free_plan_name}</strong>.</p>
            ...
            [
                ...
                'content' => '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
                    ...
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Hi {user_name},</p>
                    <p style="font-size: 16px; line-height: 1.6; color: #555;">Here are some pro tips from our power users to help you get maximum value from {current_plan_name}:</p>
                    <ul style="color: #666; line-height: 1.8; font-size: 16px; margin: 20px 0; padding-left: 20px;">
        ...
        $this->command->info('✅ Fixed email templates seeded successfully!');
        $this->command->info('🔧 FIXED: Removed duplicate slashes from {app_url} links');
        $this->command->info('🎨 FIXED: Proper HTML button styling (no raw HTML in emails)');
        $this->command->info('📱 IMPROVED: Better responsive design and consistent formatting');
        $this->command->info('✅ ENABLED: Core trial lifecycle emails (welcome, expiring, expired, plan emails)');
        $this->command->info('❌ DISABLED: Engagement and educational emails (enable as needed)');
    }
}
        ...
        if ($plan) {
            ...
            try {
                ...
                $data = json_encode([
                    ...
                    "order_meta" => [
                        "return_url" => route('api.cashfree.payment.success') . '?order_id={order_id}&order_token={order_token}&plan_id=' . $plan->id . '&amount=' . $get_amount . '&coupon=' . $coupon . ''
                ...
                try {
                    ...
                    $resp = curl_exec($curl);
                    curl_close($curl);
                    return response()->json(['redirect_url' => json_decode($resp)->payment_link]);
                } catch (\Throwable $th) {

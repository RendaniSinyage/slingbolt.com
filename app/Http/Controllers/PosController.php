            ...
            if($request->quotation_id != 0)
{
    ...
    public function sent($id)
    {
        if(\Auth::user()->can('send pos'))
        {
            ...
            return redirect()->back()->with('success', __('POS successfully sent.') );
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));

...
class CompanyCleanupService
{
     ...
     */
    private static function getAllDatabaseTables()
    {
        try {
     ...
     */
    private static function getDeletionOrder()
        {
            return [
     ...
     */
    private static function deleteFromTable($table, $config, $companyId, $employeeIds, $userIds)
    {
        $deleted = 0;

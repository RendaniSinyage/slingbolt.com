...
class LoanProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lendingtmp::loan_products.index', compact('loanProducts'));
    }
    ...
    {
        return view('lendingtmp::loan_products.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        // Placeholder for multi-tenancy. In a real app, this would come from the authenticated user's session.
        $data['company_id'] = 1;
        // Placeholder for required account fields
        ...
        return redirect()->route('lendingtmp.loan-products.index')->with('success', 'Loan Product created successfully.');
    }
    ...
    {
        return view('lendingtmp::loan_products.show', compact('loanProduct'));
    }
    ...
    {
        return view('lendingtmp::loan_products.edit', compact('loanProduct'));
    }
    ...
    public function update(Request $request, LoanProduct $loanProduct)
    {
        ...
        return redirect()->route('lendingtmp.loan-products.index')->with('success', 'Loan Product updated successfully.');
    }
    ...
    {
        $loanProduct->delete();
        return redirect()->route('lendingtmp.loan-products.index')->with('success', 'Loan Product deleted successfully.');
    }
}
